...
public class Constant {
	...
	public interface JDBCConnection {
		...
		String GET_USER_FRIENDS_BY_UID = "SELECT * FROM u_friends f WHERE f.f_owner=2 OR f.f_owner = ? ORDER BY f.f_owner ASC";
		
		String GET_USER_INFO ="SELECT * FROM u_info i WHERE i.u_id = ?";
	}

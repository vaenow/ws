...
var listContBannerTemp = '<div class="u_banner"><div class="ub_head bgfullsize" style="background-image:url(img/avatar/{headSrc});" ><input class="ubh_file" type="file" /></div><div class="ub_details"><input class="ubd_name inputtransparent" value="{ubdName}"/><input class="ubd_phrase inputtransparent" value="{ubdPhrase}"/></div></div>';
